[ AimDK_X2 ](<../index.html>)
  ...
  * 7 __FAQ
  * [8 __特殊过渡方案声明](<temp_works.html>)
    * [8.1 关闭 X2 自带的交互能力，开发您自己的语音系统](<temp_works.html#agent-only-voice>)
      * [8.1.1 临时关闭内置交互系统操作步骤](<temp_works.html#id2>)
      * [8.1.2 恢复内置交互系统操作步骤](<temp_works.html#id3>)
    * [8.2 机器人运动状态精简，v0.7.x及之前的部分McAction状态码不再支持](<temp_works.html#v0-7-xmcaction>)
...
**Q: 运行例程报错 "Package ‘examples’ not found"**
  ...
  * 参考[环境安装和配置](<../quick_start/prerequisites.html#aimdk-build>)和[运行一个代码示例](<../quick_start/run_example.html#aimdk-run>), 确认aimdk已经顺利编译且source配置
...
[ 上一页](<../example/Cpp.html> "6.2 C++接口使用示例") [下一页 ](<temp_works.html> "8 特殊过渡方案声明")
