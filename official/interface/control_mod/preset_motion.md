...
详细的编程示例和代码说明请参考：
  ...
  * **C++ 示例** ： [设置机器人动作](<../../example/Cpp.html#cpp-preset-motion>)

  * **Python 示例** ： [设置机器人动作](<../../example/Python.html#py-preset-motion>)
...
[ 上一页](<MC_control.html> "5.1.3 MC控制信号设置") [下一页 ](<endeffector.html> "5.1.5 末端执行器控制")
