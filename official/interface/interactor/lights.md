...
详细的编程示例和代码说明请参考：
  ...
  * **C++ 示例** ： [LED灯带控制](<../../example/Cpp.html#cpp-play-lights>)

  * **Python 示例** ： [LED灯带控制](<../../example/Python.html#py-play-lights>)




[ 上一页](<screen.html> "5.2.2 屏幕控制") [下一页 ](<../FASM/index.html> "5.3 故障与系统管理模块 \(待发布\)")
