...
最新 APP 版本号需与机器人最新固件版本对应，请下载正确版本使用。
...
### iOS
  ...
  * App Store 搜索应用 _Agibot Go APP_

  * 扫描下方二维码下载 Agibot Go APP


<img src='../_images/ios_qr.png' alt='iOS 下载二维码' />[ ](<../_images/ios_qr.png>)

### Android

  * 安卓应用市场搜索应用 _Agibot Go APP_

  * 扫描下方二维码下载 Agibot Go APP


<img src='../_images/ios_qr.png' alt='Android 下载二维码' />[ ](<../_images/ios_qr.png>)
...
<img src='../_images/add_robot_1.png' alt='打开添加界面' />[ ](<../_images/add_robot_1.png>)

打开添加界面

  2. 添加机器人。

<img src='../_images/add_robot_2.png' alt='添加机器人' />[ ](<../_images/add_robot_2.png>)
...
<img src='../_images/wifi_1.png' alt='Wi-Fi 连接' />[ ](<../_images/wifi_1.png>)

Wi-Fi 连接

  2. 输入 Wi-Fi 密码。

<img src='../_images/wifi_2.png' alt='输入 Wi-Fi 密码' />[ ](<../_images/wifi_2.png>)
...
<img src='../_images/ap_1.png' alt='AP 连接' />[ ](<../_images/ap_1.png>)

AP 连接

  2. 选择连接。

<img src='../_images/ap_2.png' alt='选择连接' />[ ](<../_images/ap_2.png>)
...
<img src='../_images/result_1.png' alt='连接成功' />[ ](<../_images/result_1.png>)

连接成功

  2. 可正常交互。

<img src='../_images/result_2.png' alt='可正常交互' />[ ](<../_images/result_2.png>)
...
[ 上一页](<start_up_guide.html> "2.1 开机指南") [下一页 ](<remote_controller.html> "2.3 遥控手柄连接")
