[ AimDK_X2 ](<../index.html>)
  ...
  * [4 __快速开始](<index.html>)
    * [4.1 阅读用户使用指南，熟悉相关术语及安全注意事项](<prerequisites.html>)
    * [4.2 完成基础系统配置](<prerequisites.html#id2>)
    * [4.3 网络连接](<prerequisites.html#id3>)
    * [4.4 环境安装和配置](<prerequisites.html#aimdk-build>)
    * 4.5 运行一个代码示例
      * 4.5.1 获取机器人的当前状态
      * 4.5.2 让机器人挥手
...
[ 上一页](<prerequisites.html> "4.1 阅读用户使用指南，熟悉相关术语及安全注意事项") [下一页 ](<code_sample.html> "4.6 代码编写")
