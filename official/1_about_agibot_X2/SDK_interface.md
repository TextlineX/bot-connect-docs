...
序号 | 接口类型 | 接口简称 | 接口说明  
---|---|---|---  
**1** | RJ45 | 1000 Base-T | 千兆以太网，可访问 Orin NX 与 RK3588  
**2** | RJ45 | 1000 Base-T | 千兆以太网，可访问 Orin NX 与 RK3588  
**3** | XT30UPB-F | 12V 电源 | 12V/3A 电源输出  
**4** | XT30UPB-F | 48V 电源 | 48V/5A 电源输出  
  
* * *

<img src='../_images/SDK_interface.png' alt='灵犀 X2 Ultra 旗舰版 二次开发接口布局示意' />[ ](<../_images/SDK_interface.png>)

灵犀 X2 Ultra 旗舰版 二次开发接口布局示意

[ 上一页](<user_debug_interface.html> "1.4 用户调试接口（旗舰版）") [下一页 ](<sensor_fov.html> "1.6 灵犀X2 传感器说明")
