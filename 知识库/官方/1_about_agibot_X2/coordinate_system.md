...
当各关节角度均处于零位时，机器人各部件的坐标系分布如下图所示。其中，**红色表示 X 轴，绿色表示 Y 轴，蓝色表示 Z 轴** 。

<img src='../_images/coordinate_system.png' alt='坐标系示意图' />[ ](<../_images/coordinate_system.png>)

坐标系示意图

[ 上一页](<joint_name_and_limit.html> "1.7 关节活动范围说明") [下一页 ](<../operation_guide/index.html> "2 操作指南")
